...
const Navigation = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-background/80 backdrop-blur-md shadow-md py-4 border-b border-border/50' : 'bg-transparent py-6'}`}>
