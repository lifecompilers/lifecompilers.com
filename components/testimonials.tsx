      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
          {testimonials.map((t, idx) => (
            <div
              key={idx}
              className="bg-card p-8 rounded-3xl shadow-xl shadow-black/5 dark:shadow-black/20 border border-border hover:border-primary/30 transition-all hover:-translate-y-2"
            >
              <div className="flex flex-col h-full">
                ...
                <p className="text-lg text-foreground/80 italic mb-6 flex-grow leading-relaxed">"{t.content}"</p>
